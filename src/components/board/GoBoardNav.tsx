  ...
  return (
    <>
      ...
      <div className="sm:hidden flex items-center justify-between">
        <div className="text-sm font-medium italic">{player ? player : ""}</div>
      ...
      <div className="flex items-center justify-center relative mt-2 mb-1">
        ...
        {player && (
          <div className="hidden sm:block absolute text-sm font-medium italic left-0">
            {player}
          </div>
        )}
      </div>
